...
{/*Prosedur untuk membuat POINT dengan nilai dari program atau
modul pemanggil*/
(*P).x=XX;
(*P).y=YY;
}
POINT CreatePoint (int XX, int YY)
//Fungsi untuk menghasilkan sebuah POINT berdasarkan nilai-nilai dari program atau modul pemanggil
{
POINT P;
P.x = XX;
P.y = YY;
